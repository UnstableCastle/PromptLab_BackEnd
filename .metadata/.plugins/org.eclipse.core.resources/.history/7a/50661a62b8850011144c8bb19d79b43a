...
public class AuthServiceImpl implements AuthService {
    ...
    public AuthenticationResponse register(RegisterRequest request) {
        ...
        return new AuthenticationResponse(accessToken, refreshToken, "Bearer", user.getEmail(), user.getUsername(), user.getRole().name());
    }
    ...
    public AuthenticationResponse authenticate(AuthenticationRequest request) {
        ...
        return new AuthenticationResponse(accessToken ,refreshToken, "Bearer", user.getUsername(), user.getEmail(), user.getRole().name());
    }
